<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="MovimientosCtaCteRapipago.aspx.vb"
    ...
    <script lang="javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnIngresar").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "../Servicios/Servicios.asmx/GetMovRapiPago",
                    data: "{'pObj':" + stringData + "}",
                    contentType: "application/json; charset=utf-8",
                    crossDomain: true,
                    dataType: "json",
