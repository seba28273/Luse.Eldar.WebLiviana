<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="RecargaSaldoVirtual.aspx.vb" Inherits="Page_RecargaSube" %>
        ...
        $(document).ready(function () {
            ...
            $(window).load(function () {
                ...
                $.ajax({
                    ...
                    url: "../Servicios/Servicios.asmx/GetProveedores",
            ...
            //onserverclick = "btnSolicitudPrestamo_ServerClick"
            ...
            $("#btnGrabar").click(function () {
                ...
                if ($("#txtDestino").val() == "") {
                    ...
                    $("#lblresultokfail").html("Ingrese Nro de Celular sin el 0 y sin el 15");
                ...
                $.ajax({
                    type: "POST",
                    url: "../Servicios/Servicios.asmx/GrabarVentaSaldo",
                    data: "{'pObj':" + stringData + "}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    ...
                    success: function (response) {
                        ...
                        if (val == 'Ok') {
                            ...
                            var url = UrlSitio + "/mailtemplates/MostrarImpresionTicket.aspx?Div=" + mTextoTicket + "|" + opcion_seleccionada;
